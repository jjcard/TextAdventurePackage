...
//		assertEquals(hallway.getMob("ThE baNe"), mob);
	...
	public void getExitsDescriptionsTest(){
		...
		assertTrue(exitsDescrip.contains("NORTHISH"), exitsDescrip);
		assertTrue(exitsDescrip.contains("SOUTHERNLY"), exitsDescrip);
		assertTrue(exitsDescrip.contains("NORTH"), exitsDescrip);
		assertFalse(exitsDescrip.contains("DOWN"), exitsDescrip);
		assertFalse(exitsDescrip.endsWith(", "), exitsDescrip);
		...
		assertFalse(roomDescrip.contains(" The obvious exits are "), roomDescrip);
